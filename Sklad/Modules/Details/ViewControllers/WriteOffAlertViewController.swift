//
//  WriteOffAlertViewController.swift
//  Sklad
//
...
final class WriteOffAlertViewController: UIViewController {
    
    private let viewModel: DetailsViewModel
    private var cancelables: Set<AnyCancellable> = []
    var coordinator: DetailsCoordinator?
    
    let writeOffView = WriteOffAlertView()
...
extension WriteOffAlertViewController {
